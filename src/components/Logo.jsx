    ...
    <div className={`flex items-center gap-3.5 select-none ${className}`}>
      ...
      <div className="flex flex-col justify-center leading-none">
        <div className="flex items-baseline gap-1.5">
          <span
            className={`font-serif text-lg sm:text-xl md:text-2xl font-extrabold tracking-wider ${
        ...
        <span
          className={`text-xs font-semibold tracking-tight mt-0.5 opacity-75 hidden sm:block ${
